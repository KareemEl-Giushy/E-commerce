...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2019 at 09:41 AM
...
(9, 'hamada\r\n', '2019-03-30 21:21:54', 0, 19, 1),
(10, 'this is my TV', '2019-03-30 21:22:19', 0, 18, 4),
(11, 'A good offer', '2019-03-30 21:22:28', 0, 18, 4);
...
(1, 'Play station 3 for free (black friday) for 1 hour', 'This is a ps3 for free to enjoy the black friday this is an amazing offer for just 1 hour', '0$', '2018-11-24', 'EG', '', 'like-new', 1, 0, 2, 1, 'blackfriday,free,friday'),
(3, 'samsung galexy note 8', 'This is a good mobile with good features and a good design', '500$', '2018-11-20', 'US', '', 'new', 1, 0, 3, 2, ''),
(8, 'a good used mobile iphone X for sell', 'this is an iPhone x used for 2 months you can buy it', '200$', '2018-11-30', 'US', '', 'used', 1, 0, 3, 3, ''),
(9, 'Gaming PC for sell', 'This is a high-end gaming pc to play with it is awesome', '50$', '2018-12-03', 'AR', '', 'new', 1, 0, 2, 7, ''),
(10, 'Samsung mobile phone to sell', 'A good mobile with good performance to sell', '1000$', '2018-12-04', 'FR', '', 'new', 1, 0, 3, 6, ''),
...
(13, 'blackbarry hammer', 'this is a beautiful hammer with good wood hand made', '100$', '2019-01-19', 'BE', '', 'new', 1, 0, 11, 1, 'hammer,home,equipment,tools,blackfriday'),
(17, 'Ps4 For sale', 'this is a brand new ps4 for sell it is good with a good extra game', '300$', '2019-01-20', 'BN', '', 'new', 1, 0, 2, 1, 'gamming,sales,friday,ps4'),
...
(19, 'usb adaptor from micro usb to the normal usb', 'This is a cheap small adaptor you can take it anywhere', '1.5$', '2019-01-21', 'BE', '', 'new', 1, 0, 7, 1, 'cheap,good,quality,dollaritem');
...
CREATE TABLE `users` (
  ...
  `profile-img` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(3, 'dina', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'dina.tahone@appssquare.com', 'Dina Tahone', '2018-09-11', 0, 0, 0, ''),
(4, 'eman', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'eman.abdelnamby@gmail.com', 'Eman El-Sanbouk', '2018-11-01', 0, 0, 0, '901483_coffee.png'),
...
(11, 'kemoo.64', '77e57a0282afdb65409d0a602d5701c6945fc19d', 'kemoo@kemoo.com', 'kareem salem', '2019-03-11', 0, 0, 1, '');
