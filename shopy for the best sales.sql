...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2019 at 10:37 PM
...
INSERT INTO `items` (`itemID`, `itemName`, `description`, `price`, `uDate`, `madeIn`, `item-img`, `status`, `approve`, `rating`, `Cat_ID`, `Member_ID`, `tags`, `best-sale`) VALUES
(1, 'Play station 3 for free (black friday) for 1 hour', 'This is a ps3 for free to enjoy the black friday this is an amazing offer for just 1 hour', '0$', '2018-11-24', 'EG', 'dims.jpg', 'like-new', 1, 0, 2, 1, 'blackfriday,free,friday', 0),
(3, 'samsung galexy note 8', 'This is a good mobile with good features and a good design', '500$', '2018-11-20', 'US', 's-l1000.jpg', 'new', 1, 0, 3, 2, '', 1),
(8, 'a good used mobile iphone X for sell', 'this is an iPhone x used for 2 months you can buy it', '200$', '2018-11-30', 'US', 'Apple-iPhoneX-SpaceGray-1-3x.jpg', 'used', 1, 0, 3, 3, '', 1),
(9, 'Gaming PC for sell', 'This is a high-end gaming pc to play with it is awesome', '50$', '2018-12-03', 'AR', 'Element_Main_1200-gaming-pcs.png', 'new', 1, 0, 2, 7, '', 0),
(10, 'Samsung mobile phone to sell', 'A good mobile with good performance to sell', '1000$', '2018-12-04', 'FR', 'Samsung-Galaxy-S9-Lilac-Purple-2-3x.jpg', 'new', 1, 0, 3, 6, '', 0),
(12, 'this is a tested item', 'this item is just for test nothing more than that i love to type on my keyboard it is really awsome how can i describe this feeling hello everyone i am kareem El-giushy salem test test test test test test test', '300$', '2019-01-15', 'AG', '', 'new', 0, 0, 2, 1, '', 0),
(13, 'blackbarry hammer', 'this is a beautiful hammer with good wood hand made', '100$', '2019-01-19', 'BE', '', 'new', 0, 0, 11, 1, 'hammer,home,equipment,tools,blackfriday', 0),
(17, 'Ps4 For sale', 'this is a brand new ps4 for sell it is good with a good extra game', '300$', '2019-01-20', 'BN', '5850905cv13d.jpg', 'new', 1, 0, 2, 1, 'gamming,sales,friday,ps4', 1),
(18, 'sumasung smart tv the newest version', 'This is a wonderful TV', '1000$', '2019-01-20', 'CN', '125944_20190120_193439[1].jpg', 'new', 1, 0, 7, 2, 'tv,smart', 0),
(19, 'usb adaptor from micro usb to the normal usb', 'This is a cheap small adaptor you can take it anywhere', '1.5$', '2019-01-21', 'BE', 'B8174011_TD01.jpg', 'new', 1, 0, 7, 1, 'cheap,good,quality,dollaritem', 0);
